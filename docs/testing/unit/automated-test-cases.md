...
| [loader.test.js](#loadertestjs) | `src/data/loader.js` | 43 |
| **小計** | | **159** |
...
**単体テスト総合計: 326 ケース**（統合テスト 8 件は [../integration/automated-test-cases.md](../integration/automated-test-cases.md) を参照）
