...
/// <see cref="ShowdownKey"/> 側を使う（PatchApplicator はそちらを参照済み）。ここでは patch ファイル固有の
...
internal static class PatchKey
{
    ...
    /// <remarks>各セクション内のフィールドキー（baseStats / types / abilities / basePower 等）は <see cref="ShowdownKey"/> を使う。</remarks>
