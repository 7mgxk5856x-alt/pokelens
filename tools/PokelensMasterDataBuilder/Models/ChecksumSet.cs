namespace PokelensMasterDataBuilder.Models;
...
/// <see cref="PokelensMasterDataBuilder.Pipeline.IncrementalRunner.DetermineSteps"/> の差分判定と checksums.json への保存／読み込みに用いる。
/// </remarks>
